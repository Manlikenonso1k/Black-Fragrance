        ...
        <div class="col-lg-6 col-md-12">
          <div class="detail">
            <div class="display-header">
              <h2 class="section-title">How was Black Fragrance Store started?</h2>
      ...
      <div class="row d-flex flex-wrap">
        <article class="col-md-4 post-item">
          ...
          <div class="post-content d-flex">
            ...
            <div class="post-header">
              <h3 class="post-title">
                <a href="{{ route('single-post') }}">top 10 casual look ideas to dress up your kids</a>
              </h3>
        ...
        <article class="col-md-4 post-item">
          ...
          <div class="post-content d-flex">
            ...
            <div class="post-header">
              <h3 class="post-title">
                <a href="{{ route('single-post') }}">Latest trends of wearing street wears supremely</a>
              </h3>
        ...
        <article class="col-md-4 post-item">
          ...
          <div class="post-content d-flex">
            ...
            <div class="post-header">
              <h3 class="post-title">
                <a href="{{ route('single-post') }}">types of comfortable clothes ideas for women</a>
              </h3>
