...
<body>
                ...
                <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                  <ul class="menu-list">
                    ...
                    <li class="menu-item has-sub">
                      <a href="{{ route('home') }}" class="item-anchor active d-flex align-item-center"
                        data-effect="Home">Home<i class="icon icon-chevron-down"></i></a>
                      <ul class="submenu">
                        <li><a href="{{ route('home') }}" class="item-anchor active">Home</a></li>
                        <li><a href="/home2" class="item-anchor">Home v2<span class="text-primary"> (PRO)</span></a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li class="menu-item has-sub">
                      <a href="{{ route('shop') }}" class="item-anchor d-flex align-item-center"
                        data-effect="Shop">Shop<i class="icon icon-chevron-down"></i></a>
                      <ul class="submenu">
                        <li><a href="{{ route('shop') }}" class="item-anchor">Shop</a></li>
                        <li><a href="/shop-slider" class="item-anchor">Shop slider<span class="text-primary">
                              (PRO)</span></a></li>
                        <li><a href="/shop-grid" class="item-anchor">Shop grid<span class="text-primary">
                              (PRO)</span></a></li>
                        <li><a href="/shop-list" class="item-anchor">Shop list<span class="text-primary">
                              (PRO)</span></a></li>
                        <li><a href="/product" class="item-anchor">Single product<span class="text-primary">
                              (PRO)</span></a></li>
                        <li><a href="/cart" class="item-anchor">Cart<span class="text-primary"> (PRO)</span></a></li>
                        <li><a href="/wishlist" class="item-anchor">Wishlist<span class="text-primary"> (PRO)</span></a>
                        </li>
                        <li><a href="/checkout" class="item-anchor">Checkout<span class="text-primary"> (PRO)</span></a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li class="menu-item has-sub">
                      ...
                      <ul class="submenu">
                        <li><a href="/coming-soon" class="item-anchor">Coming soon<span class="text-primary">
                              (PRO)</span></a></li>
                        ...
                        <li><a href="/error" class="item-anchor">Error page<span class="text-primary"> (PRO)</span></a>
                        </li>
                      </ul>
                    </li>

                    <li class="menu-item has-sub">
                      <a href="{{ route('blog') }}" class="item-anchor d-flex align-item-center"
                        data-effect="Blog">Blog<i class="icon icon-chevron-down"></i></a>
                      <ul class="submenu">
                        <li><a href="{{ route('blog') }}" class="item-anchor">Blog</a></li>
                        <li><a href="/blog-sidebar" class="item-anchor">Blog with sidebar<span class="text-primary">
                              (PRO)</span></a></li>
                        <li><a href="/blog-masonry" class="item-anchor">Blog masonry<span class="text-primary">
                              (PRO)</span></a></li>
  ...
  <a href="https://wa.me/2348184161506" class="whatsapp-float" target="_blank" rel="noopener noreferrer"
    aria-label="Contact Black Fragrance on WhatsApp">
  ...
  <div id="footer-bottom">
    <div class="container">
      <div class="d-flex align-items-center flex-wrap justify-content-between">
        <div class="copyright">
          <p>Made with love by <a href="https://nonsostudio.com/">Chinonso</a>
          </p>
        </div>
